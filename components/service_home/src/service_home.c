...
void home_service_refresh_snapshot(void)
{
    ...
    copy_text(s_snapshot.time_hhmm, sizeof(s_snapshot.time_hhmm), time_snapshot->hhmm);
    copy_text(s_snapshot.date_text, sizeof(s_snapshot.date_text), time_snapshot->date_text);
    copy_text(s_snapshot.weekday_text, sizeof(s_snapshot.weekday_text), time_snapshot->weekday_text);
...
{
    return weather_service_can_refresh();
}
